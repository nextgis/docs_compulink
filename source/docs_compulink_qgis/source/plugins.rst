...
ГИС Компьюлинк была разработана на архитектуре с поддержкой различных модулей, которые позволяют 
добавлять множество новых возможностей или функций в приложение. ГИС Компьюлинк предоставляет 
библиотеки, которые могут использоваться для создания модулей. 
Большинство функций в ГИС Компьюлинк реализованы как основные или внешние модули. 
...
быть добавлены с помощью функции Установка модулей ГИС Компьюлинк. 
...
Подробнее о модулях расширения, разработанных специально для ГИС Компьюлинк, можно почитать в следующих разделах.
