...
ГИС Компьюлинк использует библиотеку GDAL для чтения и записи растровых форматов. 
Растр поддержка GRASS поставляется нативной ГИС Компьюлинк плагин поставщика данных. Растровые 
данные также могут быть загружены в режиме чтения из почтового индекса и GZIP архивов в ГИС Компьюлинк.
...
карте. Выделение прямоугольником имеет смысл только если в окне ГИС Компьюлинк выставлена 
