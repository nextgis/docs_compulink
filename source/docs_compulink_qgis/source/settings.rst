...
Некоторые основные параметры ГИС Компьюлинк могут быть определены в диалоговом окне "Параметры".
...
- Предупреждать при попытке открытия файлов проекта старых версий ГИС Компьюлинк.
...
- Запрашивать загрузку дочерних слоёв растра. Некоторые форматы растровых данных 
  ...
  Эта настройка определяет обработку таких файлов ГИС Компьюлинк. 
...
- "Пропускать" не используйте этот параметр, в следующих версиях ГИС Компьюлинк он будет удален.
...
- Настроить Проверку геометрии. Редактирование сложных линий/полигонов с большим 
  ...
  проверки геометрии, используемая в ГИС Компьюлинк по умолчанию довольно медленная. Ускорить 
...
Вторая группа позволяет определить поведение ГИС Компьюлинк при создании нового слоя или при 
...
изменений может потребовать перезапуска ГИС Компьюлинк для их применения.
