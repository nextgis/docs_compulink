...
NextGIS WEB поддерживает рендеринг с помощью библиотеки Mapserver.
Стиль Mapserver можно писать самостоятельно в текстовом виде, или импортировать из стилей QGIS.
