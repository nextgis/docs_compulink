...
.. figure:: _static/admin_index.png
   ...
   5 – типы объектов, которые можно добавлять в основную группу;
   6 – операции которые можно проводить с основной группой.
...
Блок "Права пользователя" (см. :numref:`admin_index_pic` п. 4) включает в себя
...
В блоке операций (см. :numref:`admin_index_pic`. 5 и 6) имеются инструменты для
...
а так же создать специфичные типы ресурсы:
...
Панель управления позволяет выполнять следующие общие действия:
...
а также специфичные задачи:

* Настройку параметров записи видео
* Просмотр и редактирование справочников административно-территориального деления
* Просмотр и редактирование справочника проектов строительства
* Просмотр диагностических сообщений с мобильных устройств
...
В таблице дочерних ресурсов обозначены названия и типы слоев этих ресурсов.
Для примера выбираем из таблицы ресурс с типом - векторный слой (см. :numref:`resource_group1`).
