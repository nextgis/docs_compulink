...
htmlhelp_basename = 'nextgisdbdoc'
...
latex_documents = [
  (master_doc, 'compulink_docs_db.tex', u'Описание структуры БД NextGIS Web Compulink',
   author, 'manual', 'true')
]
...
man_pages = [
    (master_doc, 'nextgisdb', u'Документация Compulink',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'NextGISDb', u'Описание структуры БД NextGIS Web Compulink',
   author, 'NextGISDb', 'One line description of project.',
   'Miscellaneous'),
]
